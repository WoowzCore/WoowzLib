...
public struct Vector3D : IEquatable<Vector3D>, WLI.Packable{
	...
	public double LengthSquared {[MethodImpl(MethodImplOptions.AggressiveInlining)]
		get => WL.Math.LengthSquared3D(X, Y, Z); }
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public double DistanceSquared(Vector3D B) => WL.Math.DistanceSquared3D(X, Y, Z, B.X, B.Y, B.Z);
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public double Distance(Vector3D B) => WL.Math.Distance3D(X, Y, Z, B.X, B.Y, B.Z);
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static double DistanceSquared(Vector3D A, Vector3D B) => A.DistanceSquared(B);
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static double Distance(Vector3D A, Vector3D B) => A.Distance(B); 
