...
public struct Vector2D : IEquatable<Vector2D>, WLI.Packable{
	...
	public double LengthSquared {[MethodImpl(MethodImplOptions.AggressiveInlining)]
		get => WL.Math.LengthSquared2D(X, Y); }
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public double DistanceSquared(Vector2D B) => WL.Math.DistanceSquared2D(X, Y, B.X, B.Y);
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public double Distance(Vector2D B) => WL.Math.Distance2D(X, Y, B.X, B.Y);
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static double DistanceSquared(Vector2D A, Vector2D B) => A.DistanceSquared(B);
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static double Distance(Vector2D A, Vector2D B) => A.Distance(B); 
