...
public class OpenGL : WLI_Render.Hardware, IEquatable<OpenGL>{
    ...
    #region Запуск/Остановка
        ...
        public unsafe void Start(){
            try{
                ...
                API = CreateAPI(API_ProcessLoader);
                ...
                if(API_HasDebugLogger){
                    ...
                    SetupDebugLogger(API, API_DebugLogger);
    ...
    public GLMesh CreateMesh<T>(VertexLayout Layout, T[] Vertices, uint[]? Indices = null) where T : unmanaged{
